...
parser.add_argument('--models', default='', type=str, metavar='MODEL',
                    help='Name of models to train (default: "countception"')
...
parser.add_argument('--aug-splits', type=int, default=0,
                    help='Number of augmentation splits (default: 0, val: 0 or >=2)')
...
parser.add_argument('--models-ema', action='store_true', default=True,
                    help='Enable tracking moving average of models weights')
parser.add_argument('--models-ema-force-cpu', action='store_true', default=False,
                    help='Force ema to be tracked on CPU, rank=0 node only. Disables EMA validation.')
parser.add_argument('--models-ema-decay', type=float, default=0.99996,
...
parser.add_argument('--finetune', default='', type=str, metavar='PATH',
                    help='finetune full models and optimizer state from checkpoint (default: none)')
parser.add_argument('--fine-22k', action='store_true', default=False,
                    help='finetune 22k models')
...
def main():
    ...
    if args.jsd:
        assert num_aug_splits > 1  # JSD only val with aug splits set
