...
```shell
./dist_classification.sh 8 -c configs/imagenet.yml --models cct_14_7x2_224 /path/to/ImageNet
```

### Non-distributed training
```shell
python train.py -c configs/datasets/cifar10.yml --models cct_7_3x1_32 /path/to/cifar10
```
