...
def main(args):
    ...
    # List of ConvNeXt variants to train
    variants = [
        # 'convnext_tiny',
        # 'convnext_small',
        'convnext_base']
    ...
    for model_name in variants:
        ...
        early_stopping = EarlyStopping(patience=10, verbose=True, path=os.path.join(output_dir, f'convnext_{variant}_best.pth'))
        ...
        # Save final models
        try:
            torch.save(model.state_dict(), os.path.join(output_dir, f"convnext_{variant}_final.pth"))
        except Exception as e:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train ConvNeXt variants for tomato leaf disease classification")
