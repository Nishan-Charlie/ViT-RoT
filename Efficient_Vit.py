...
def main(args):
    ...
    output_dir = 'outputs_efficientvit'
    try:
    ...
    variants = [
        ('b0', 'efficientvit_b0.r224_in1k'),
        ('b2', 'efficientvit_b2.r224_in1k'),
    ...
    for variant, model_name in variants:
        ...
        scaler = GradScaler()
        early_stopping = EarlyStopping(patience=10, verbose=True, path=os.path.join(output_dir, f'efficientvit_{variant}_best.pth'))
        ...
        try:
            torch.save(model.state_dict(), os.path.join(output_dir, f"efficientvit_{variant}_final.pth"))
        except Exception as e:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train EfficientViT variants for tomato leaf disease classification")
